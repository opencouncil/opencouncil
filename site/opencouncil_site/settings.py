# Django settings for opencouncil_site project.
import os
DEBUG = True
...
SECRET_KEY = '3j22!yrk567zlc*p30t^9$u66@uz^z=)44hp5!wi-fr^!$xd+j'
...
ROOT_URLCONF = 'opencouncil_site.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'opencouncil_site.wsgi.application'
